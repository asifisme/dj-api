...
from xApiLedger.models import JournalEntryModel 
...
def handle_payment_post_save(sender, instance, created, **kwargs):
    ...
    """
    if created:
        if xcontroller.GLOBAL_EMAIL_SYSTEM and instance.stripe_checkout_id:
            # Send payment confirmation email
            send_payment_eamil(instance) 

        if xcontroller.GLOBAL_JOURNAL_SYSTEM and instance.stripe_checkout_id:
